...
TEST(logistic_coverage, test1) {
    Project3 pl;
    pl.mend = false;
    pl.mnowline = 1;
    pl.mnowcolumn = 0;
    ifstream inputFile("./test/testfile/test_logistic_coverage1.txt");
    streambuf* originalCinBuf = cin.rdbuf(inputFile.rdbuf());
    string test_outcome = "";
    ...
    string line;
    string ans_outcome = "";
    ansFile.open("./test/ansfile/test_logistic_coverage1_ans.txt");
...
TEST(logistic_coverage, test2) {
    Project3 pl;
    pl.mend = false;
    pl.mnowline = 1;
    pl.mnowcolumn = 0;
    ifstream inputFile("./test/testfile/test_logistic_coverage2.txt");
    streambuf* originalCinBuf = cin.rdbuf(inputFile.rdbuf());
    string test_outcome = "";
    ...
    string line;
    string ans_outcome = "";
    ansFile.open("./test/ansfile/test_logistic_coverage2_ans.txt");
...
TEST(logistic_coverage, test3) {
    Project3 pl;
    pl.mend = false;
    pl.mnowline = 1;
    pl.mnowcolumn = 0;
    ifstream inputFile("./test/testfile/test_logistic_coverage3.txt");
    streambuf* originalCinBuf = cin.rdbuf(inputFile.rdbuf());
    string test_outcome = "";
    ...
    string line;
    string ans_outcome = "";
    ansFile.open("./test/ansfile/test_logistic_coverage3_ans.txt");
